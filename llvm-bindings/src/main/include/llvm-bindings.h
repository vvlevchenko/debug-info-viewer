...
const char *LLVMInstructionCallGetCalleeName(LLVMValueRef);
...
DISubprogramRef LLVMLocalScopeGetSubprogram(DILocalScopeRef);
const char *LLVMSubprogramGetName(DISubprogramRef);
